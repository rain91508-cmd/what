...
| 3 | 8 | 8:1 | 每 8 个转换点合并为 min/max |
| 4 | 16 | 16:1 | 每 16 个转换点合并为 min/max |
| 5 | 32 | 32:1 | 每 32 个转换点合并为 min/max |
| 6 | 64 | 64:1 | 每 64 个转换点合并为 min/max |
| 7 | 128 | 128:1 | 每 128 个转换点合并为 min/max |
| 8 | 256 | 256:1 | 每 256 个转换点合并为 min/max |
| 9 | 512 | 512:1 | 每 512 个转换点合并为 min/max |
| 10 | 1,024 | 1024:1 | 每 1024 个转换点合并为 min/max |
| 11 | 2,048 | 2048:1 | 每 2048 个转换点合并为 min/max |
| 12 | 4,096 | 4096:1 | 每 4096 个转换点合并为 min/max |
| 13 | 8,192 | 8192:1 | 每 8192 个转换点合并为 min/max |
| 14 | 16,384 | 16384:1 | 每 16384 个转换点合并为 min/max |
| 15 | 32,768 | 32768:1 | 每 32768 个转换点合并为 min/max |
| 16 | 65,536 | 65536:1 | 每 65536 个转换点合并为 min/max |
| 17 | 131,072 | ~13万:1 | 超高级压缩 |
| 18 | 262,144 | ~26万:1 | 极高级压缩 |
| 19 | 524,288 | ~52万:1 | 超极高级压缩 |
| 20 | 1,048,576 | ~100万:1 | 百万级压缩 |
| 21 | 2,097,152 | ~200万:1 | 超百万级压缩 |
| 22 | 4,194,304 | ~400万:1 | 四百万级压缩 |
| 23 | 8,388,608 | ~800万:1 | 八百万级压缩 |
| 24 | 16,777,216 | ~1600万:1 | 千万级压缩 |
| 25 | 33,554,432 | ~3300万:1 | 超千万级压缩 |
| 26 | 67,108,864 | ~6700万:1 | 六七千万级压缩 |
| 27 | 134,217,728 | ~1.3亿:1 | 亿级压缩 |
| 28 | 268,435,456 | ~2.7亿:1 | 超亿级压缩 |
| 29 | 536,870,912 | ~5.4亿:1 | 五亿级压缩 |
| 30 | 1,073,741,824 | ~10亿:1 | 十亿级压缩 |
| 31 | 2,147,483,648 | ~21亿:1 | 二十亿级压缩 |
| 32 | 4,294,967,296 | ~43亿:1 | 最大压缩层级 |
...
- **Min/Max 输出规则**: 当 bucket 内 min ≠ max 或包含 X/Z 状态时，在 bucket 结束点输出 max 值，确保波形变化被正确表示
