...
const translations: Translations = {
  ...
  menuItems: {
    ...
    prefetchRequiresCache: 'requires OPFS + Memory',
  ...
  dialog: {
    ...
    cachedKdb: {
      title: 'Open Cached KDB',
      loading: 'Loading cached KDBs...',
      error: 'Failed to list cached KDBs',
      empty: 'No cached KDBs found',
      noMatching: 'No cached KDB matches the filter',
