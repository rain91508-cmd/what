// ============================================
// Knowledge Manager - Local Query Engine
// ============================================
//
// Responsibilities (per spec.md):
// - Load and manage Knowledge Base from IndexedDB
// - Provide local query capabilities
// - Signal management (groups, bus operations, value formatting)
